...
async function generateBackgroundTiles() {
  ...
  const rowHeight = 208;
  const numRows = Math.ceil(window.innerHeight / rowHeight) * 3; // 3倍にしてTVBROでも十分な行数を確保
...
async function showSlideshowScreen() {
  ...
  if (isScreensaverMode) {
    ...
    bgTiles.style.zIndex = '15';    // 画像コンテナ(11)より前、オーバーレイ(100)より後ろ
